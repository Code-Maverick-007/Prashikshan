...
const InternshipInvitesPage = () => {
    // This component will be rendered within a layout that should handle the page margins (e.g., lg:ml-64)
    return (
        <EmptyState 
            icon={Mail} 
            title="No Internship Invites" 
            message="Companies can invite you to apply directly. Keep your profile updated to attract opportunities!" 
        />
    );
};

export default InternshipInvitesPage;